...
# Crie uma conta no Kaggle, uma das principais plataformas de ciência de dados e aprendizado de máquina. 
# Em disciplinas avançadas vamos trabalhar com bases de dados provenientes de lá! (http://kaggle.com/)
...
# Após compreender a estrutura do arquivo (divisão em colunas, caracter separador de coluna, etc.) 
# passamos para a etapa de extração de informações.
...
# Você deve criar um script Python para processar esse arquivo e gerar uma lista com 10 elementos, cada qual representando 
# a música mais tocada de cada ano no intervalo de 2012 a 2022. Considere somente músicas dentro do intervalo solicitado. 
# Cada elemento da lista produzida deve conter as seguintes informações:
# [track_name, artist(s)_name, released_year, streams]
# Essa atividade tem alguns desafios. Assim como as colunas da tabela são separadas por vírgulas, 
# músicas com mais de um artista (artist_count>1) terá o campo artist(s)_name entre aspas com o nome dos artistas separado por vírgulas. 
