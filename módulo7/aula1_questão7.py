...
# rabalharemos apenas com o intervalo de caracteres visíveis (entre 33 e 126 na tabela Unicode)
...
def encrypt(nomes):    
    ...
    for nome in nomes:
        nome_criptografado = ""
        for char in nome:        
            novo_char = chr(((ord(char) + chave_criptografia - 33) % 94) + 33)
            nome_criptografado += novo_char        
      
        nomes_criptografados.append(nome_criptografado)    
    return nomes_criptografados, chave_criptografia
